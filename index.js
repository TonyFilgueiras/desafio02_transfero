...
function graph(label, data, coin, chart = myChart) {
...
percentage_calculator(dados_mes_ibov, dados_mes_ibov_percentage)
percentage_calculator(dados_semana_ibov, dados_semana_ibov_percentage)
...
function graph_change() {
    if (semanaradio.checked) {
        var x = checking_for_percentage(dados_semana_ibov,dados_semana_ibov_percentage)
        ...
        anobox.style.color = "white"
        graph(label_semana, x,coin)
    }
    if (mesradio.checked) {
        var y = checking_for_percentage(dados_mes_ibov,dados_mes_ibov_percentage)
    ...
    if (anoradio.checked) {
        ...
        mesbox.style.color = "white"
        anobox.style.color = "black"
        graph(label_ano, z, coin)
    }    
}
